...
class Game extends Component {
  ...
  render() {
    ...
    return (
      <div className="bg-orange-900 text-white flex flex-col justify-center items-center w-screen min-h-screen h-auto p-32">
        ...
        {route === "menu" ? (
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex mt-8">
              <Button onUp={this.onUp} onDown={this.onDown} onLeft={this.onLeft} onRight={this.onRight} />
            </div>
          </div>
        )}
      </div>
