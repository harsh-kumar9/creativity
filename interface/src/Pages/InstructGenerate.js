...
const InstructGenerate = () => {
    ...
    return (
        <div style={{ backgroundImage: `url(${background})` }} className="text-white h-auto w-screen items-center justify-center space-y-8 p-14 bg-cover">
            ...
            <p className="text-2xl mb-4">In the Practice round, to spark your imagination, you’ll see ideas generated by AI (i.e., ChatGPT). This will be shown on the right side of the screen.</p>
