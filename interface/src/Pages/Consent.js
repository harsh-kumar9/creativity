    ...
    return (
        <div style={{ backgroundImage: `url(${background})` }} className="text-white h-auto w-screen items-center justify-center space-y-8 p-14 bg-cover">
            ...
            <div className="consent-form text-lg">
                ...
                <p className="text-main mb-2">We expect the survey to take around <strong>10 minutes</strong> to complete. If you are a <em>Prolific worker</em>, you will receive the monetary amount detailed on Prolific as compensation for your time. If you were recruited offline, you will be entered into a draw for <strong>5 USD Amazon gift cards</strong>. Odds are detailed in the advertisement post, but you can expect a winning probability of at least 30%.</p>
                ...
                <p className="text-main mb-2">You may decline to participate or withdraw at any time without penalty. If you decide to withdraw from the study after participating, you may do so any time before the results are published. If you wish to withdraw during your participation in Prolific Turk, you may simply close the browser window with the experiment and return the task.</p>
                <p className="text-main mb-2">Note that you will be compensated only after you have completed the activity and have successfully verified your <strong>Prolific ID</strong>. Please allow <strong>2-3 days</strong> for this process.</p>
