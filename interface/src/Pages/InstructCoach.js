...
const InstructCoach = () => {
    ...
    return (
        <div style={{ backgroundImage: `url(${background})` }} className="text-white h-auto w-screen items-center justify-center space-y-8 p-14 bg-cover">
            ...
            <p className="text-2xl  mb-4">In this task, you will be shown an object and asked to come up with original and creative uses for the object. You will see 3 objects in a Practice round, followed by one more object in a Test round. </p>
            ...
            <p className="text-2xl mb-4">In the Practice round, to spark your imagination, you will receive guidance from AI (i.e., ChatGPT) to help you come up with creative ideas. This will be shown on the right side of the screen.</p>
